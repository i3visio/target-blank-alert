...
information["greeting"] = vulnerables;

chrome.runtime.sendMessage({info: information}, function(response) {
...
chrome.extension.onMessage.addListener(function(msg, sender, sendResponse) {
  if (msg.task == 'recover_vulnerable_links') {
    // We send extra information with the host and the url
    information["host"] = window.location.host;
